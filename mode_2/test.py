...
v2 = Constant((-1,0))
n = FacetNormal(mesh)
load_test2 = assemble(inner(dot(sigma(u),n),v1) * ds(41))
load_test3 = assemble(inner(dot(sigma(u),n),v2) * ds(42))
v3 = Constant((0,-1))
load_test4 = assemble(inner(dot(sigma(u),n),v3) * ds(42))
print(load_test2+load_test3+load_test4)
